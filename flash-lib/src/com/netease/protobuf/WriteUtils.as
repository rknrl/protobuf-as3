...
package com.netease.protobuf {
	...
	public final class WriteUtils {
		...
		public static function write$TYPE_ENUM(output:WritingBuffer, value:Enum):void {
			write$TYPE_INT32(output, value.id())
		}
		public static function write$TYPE_SFIXED32(output:WritingBuffer, value:int):void {
			write$TYPE_FIXED32(output, value)
		}
		...
		public static function write$TYPE_MESSAGE(output:WritingBuffer, value:IMessage):void {
			const i:uint = output.beginBlock()
